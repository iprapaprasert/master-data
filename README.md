...
## Notes on convention after flattening
- Flattening `nso_dim_industry.csv` gets 5 levels. Use this naming (from the lowest-level to the highest-level): (1) `IndustryKey` (2) `IndustryClassKey` (3) `IndustryGroupKey` (4) `IndustryDivisionKey` and (5) `IndustrySectionKey`.
